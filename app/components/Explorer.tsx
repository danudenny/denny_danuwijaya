...
const Explorer = () => {
  ...
  React.useEffect(() => {
    ...
    const bounds = filteredPins.length > 0 ? getBounds(filteredPins) : initialBounds;
      ...
      <div className="max-w-6xl mx-auto px-8">
        ...
        >
          ...
          <p className="text-lg opacity-80">
            Discover my professional journey across the globe. Each marker represents a significant milestone in my career.
          </p>
        </motion.div>
                ...
                {filteredPins.map((pin) => (
                  ...
                  >
                    ...
                    >
                      <motion.div
                        animate={{
                          scale: hoveredPin === pin.id || selectedPin === pin.id ? 1.2 : 1,
                          y: hoveredPin === pin.id || selectedPin === pin.id ? -4 : 0,
                        }}
            ...
            <div className="flex flex-col space-y-3">
              <div className="flex items-center justify-between">
                <div className="text-sm opacity-80">
                  {selectedYear ? `Showing experiences up to ${selectedYear}` : 'All experiences'}
                </div>
                {selectedYear && (
                  <button
                ...
                {years.map((year) => (
                  <motion.button
                    ...
                    className={`relative px-3 py-1.5 brutal-btn ${
                      year === selectedYear ? 'brutal-btn-active' : ''
                    }`}
